        ...
        <div class="rounded-[1rem] border p-4 surface-panel-soft">
          ...
          <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.focusHorizontalSizePercent
                "
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.focusVerticalSizePercent
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="5"
                max="100"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.horizontalOffsetDegrees
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="-45"
                max="45"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.verticalOffsetDegrees
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="-45"
                max="45"
        ...
        <div class="rounded-[1rem] border p-4 surface-panel-soft">
          ...
          <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <label class="block">
              ...
              <input
                v-model.number="config.modules.quadviews.defaults.focusScale"
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0.5"
                max="2"
                step="0.05"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.peripheralScale
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0.1"
                max="1.5"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.foveateSharpness
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0"
                max="100"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.transitionThicknessPercent
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0"
                max="50"
        ...
        <div class="rounded-[1rem] border p-4 surface-panel-soft">
          ...
          <div class="mt-3 grid gap-3">
            <label class="block">
              ...
              <select
                v-model="config.modules.quadviews.defaults.trackingMode"
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              >
            ...
            <label class="block">
              ...
              <input
                v-model.number="config.modules.quadviews.defaults.gazeSmoothing"
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0"
                max="1"
                step="0.01"
            ...
            <label class="block">
              ...
              <input
                v-model.number="
                  config.modules.quadviews.defaults.gazeDeadzoneDegrees
                "
                class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
                min="0"
                max="10"
        ...
        <div class="mt-4 grid gap-3 lg:grid-cols-4">
          <label class="block">
            <span class="mb-1.5 flex items-center gap-1.5 text-sm font-medium">
              Mode
              <span
                title="Chooses whether this application's focus area follows head direction or eye gaze."
                class="cursor-help select-none text-xs text-muted"
                >ⓘ</span
              >
            </span>
            <select
              v-model="profile.settings.trackingMode"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
            >
              <option value="head">Head tracked</option>
              <option value="eye">Eye tracked</option>
          ...
          <label class="block">
            <span class="mb-1.5 flex items-center gap-1.5 text-sm font-medium">
              Focus Width
              <span
                title="Width of this application's high-detail focus area as a percent of the projected eye view."
                class="cursor-help select-none text-xs text-muted"
                >ⓘ</span
              >
            </span>
            <input
              v-model.number="profile.settings.focusHorizontalSizePercent"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="5"
              max="100"
              step="1"
          ...
          <label class="block">
            <span class="mb-1.5 flex items-center gap-1.5 text-sm font-medium">
              Focus Height
              <span
                title="Height of this application's high-detail focus area as a percent of the projected eye view."
                class="cursor-help select-none text-xs text-muted"
                >ⓘ</span
              >
            </span>
            <input
              v-model.number="profile.settings.focusVerticalSizePercent"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="5"
              max="100"
              step="1"
          ...
          <label class="block">
            ...
            <input
              v-model.number="profile.settings.focusScale"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="0.5"
              max="2"
              step="0.05"
          ...
          <label class="block">
            <span class="mb-1.5 flex items-center gap-1.5 text-sm font-medium">
              Peripheral Scale
              <span
                title="Resolution scale for this application's outer peripheral views. Lower values can improve frame rate."
                class="cursor-help select-none text-xs text-muted"
                >ⓘ</span
              >
            </span>
            <input
              v-model.number="profile.settings.peripheralScale"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="0.1"
              max="1.5"
              step="0.05"
          ...
          <label class="block">
            ...
            <input
              v-model.number="profile.settings.foveateSharpness"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="0"
              max="100"
              step="1"
          ...
          <label class="block">
            ...
            <input
              v-model.number="profile.settings.transitionThicknessPercent"
              class="app-input w-full rounded-[0.75rem] px-4 py-2.5"
              min="0"
              max="50"
              step="1"
