...
struct PerformanceSessionSummary {
    ...
    target_frame_ms: f64,
    target_hz: f64,
    loading_gap_threshold_ms: f64,
    wait_frames: u64,
    begin_frames: u64,
    end_frames: u64,
    frame_samples: u64,
    excluded_frame_samples: u64,
    excluded_frame_duration_ms: f64,
    excluded_frame_max_ms: f64,
    frame_avg_ms: f64,
    frame_p95_ms: f64,
    frame_p99_ms: f64,
    frame_min_ms: f64,
    ...
    excluded_cpu_span_samples: u64,
    excluded_cpu_span_duration_ms: f64,
    excluded_cpu_span_max_ms: f64,
    cpu_span_avg_ms: f64,
    cpu_span_min_ms: f64,
    cpu_span_max_ms: f64,
    raw_line: String,
...
fn parse_performance_session_line(
    ...
    Some(PerformanceSessionSummary {
        ...
        loading_gap_threshold_ms: parse_summary_f64(&values, "loadingGapThresholdMs"),
        ...
        excluded_frame_samples: parse_summary_u64(&values, "excludedFrameSamples"),
        excluded_frame_duration_ms: parse_summary_f64(&values, "excludedFrameDurationMs"),
        excluded_frame_max_ms: parse_summary_f64(&values, "excludedFrameMaxMs"),
        ...
        excluded_cpu_span_samples: parse_summary_u64(&values, "excludedCpuSpanSamples"),
        excluded_cpu_span_duration_ms: parse_summary_f64(&values, "excludedCpuSpanDurationMs"),
        excluded_cpu_span_max_ms: parse_summary_f64(&values, "excludedCpuSpanMaxMs"),
